...
@Config(sdk = [34])
class BienvenidaScreenRoboTest {
    ...
    @Test
    fun displaysAppName() {
        composeTestRule.setContent { TravelHubAppMobileTheme { BienvenidaScreen(onLogin = {}, onRegistro = {}) } }
    ...
    fun displaysTermsText() {
        composeTestRule.setContent { TravelHubAppMobileTheme { BienvenidaScreen(onLogin = {}, onRegistro = {}) } }
        composeTestRule.onNodeWithText("Al continuar, aceptas nuestros Términos de servicio y Política de privacidad").assertIsDisplayed()
    }

    @Test
    fun loginButtonClick_callsCallback() {
        var clicked = false
        composeTestRule.setContent { TravelHubAppMobileTheme { BienvenidaScreen(onLogin = { clicked = true }, onRegistro = {}) } }
    ...
    fun registerButtonClick_callsCallback() {
        var clicked = false
        composeTestRule.setContent { TravelHubAppMobileTheme { BienvenidaScreen(onLogin = {}, onRegistro = { clicked = true }) } }
